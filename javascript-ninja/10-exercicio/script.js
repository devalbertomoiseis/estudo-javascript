...
*/
console.log(brazilianFoods.push("Coxinha", null, "Brigadeiro"))
...
const maleDogNames = ["joao", "tiao"]
const femaleDogNames = ["maria", "joana"]
...
console.log(dogNames[dogNames.length-1]) // retorna o ultimo item
...
*/
dogNames.push('Nina')
const initals = `${dogNames[0][0]} ${dogNames[1][0]} ${dogNames[2][0]} ${dogNames[3][0]}`
...
const dessert = `${dogNames[0].slice(3)} ${dogNames[1].slice(2)}`.replace('n', 'a')

console.log(`A ${dessert} é um doce à base de coco, tradicional na América Latina e em Angola.`)
/*
12 - Comente o console.log acima e:

- Declare um array com os números 1,2,3,4,5 e o armazene em uma let
"oddNumbers";
...
já tem, mais 4;
- Agora, o resultado exibido no console deve ser 216.
*/
