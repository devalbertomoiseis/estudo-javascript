...
- Ao invés de inserir manualmente a posição do último caractere, faça com que
 a obtenção da última letra funcione para qualquer palavra que a "randomWord" receber;
- Dica: utilize a propriedade ".length".
*/

let randomWord = 'Araponga'
randomWord = 'ovo'
console.log(randomWord[randomWord.length - 1]) // Pegar o último caracterer da palavra
/*
...
*/
const allEpisodes = 'O n° de episodios é: ' + episodes
...
let newName = nome[0].toUpperCase() + nome.slice(1, 5) + ' ' + nome[7].toUpperCase()+nome.slice(8,12);
console.log(newName)
...
- Exiba a "newName" no console;
*/
newName = `${nome[0].toUpperCase()} ${nome.slice(1,6)} ${nome[7].toUpperCase}`
